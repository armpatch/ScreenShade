...
public class OverlayService_backup extends Service {
    ...
    public static Intent getIntent(Context context) {
        return new Intent(context, OverlayService_backup.class);
    }
    ...
    private void showOverlayControls() {
        ...
        mOverlayControlsView = inflate(context, R.layout._backup_window_controls, null);
