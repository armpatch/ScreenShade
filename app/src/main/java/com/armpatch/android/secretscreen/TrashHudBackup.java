...
public class TrashHudBackup extends Service {

    // constants
    public static final String BASIC_TAG = TrashHudBackup.class.getName();
    ...
    public static Intent getIntent(Context context) {
        Intent intent = new Intent(context, TrashHudBackup.class);
        return intent;
    }
